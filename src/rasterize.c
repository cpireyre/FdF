...
static void	connect(mlx_image_t *img, t_vector a, t_vector b)
{
	...
	double	start_proportion;
	double	end_proportion;
	...
	{
	    start_proportion = ft_distance(a.x, a.y, line.x0, line.y0) / original_length;
	    end_proportion = ft_distance(a.x, a.y, line.x1, line.y1) / original_length;
